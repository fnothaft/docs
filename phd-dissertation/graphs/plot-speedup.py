...
plot(n, bg, 'Avocado', 'bx-')
plot(n[1:], hc, 'Haplotype Caller', 'c.--')

label("speedup-gt.pdf",
      "Genotyping Speedup on NA12878 (High Coverage)")
