...
systems. While much work has focused on debugging errors~\cite{alvaro15, dave13}
...
cause several orders of magnitude increased coverage.

\section{Extensions to \textsc{Avocado}}
\label{sec:extending-avocado}

\subsection{Deep Learning for Variant Calling}
