...
widely used open-source distributed processing architectures like {Apache
...
interface~(API) for processing genomic data using Apache Spark. {ADAM}
...
Our work on {ADAM} has resulted in the broad ecosystem of projects,
...
To demonstrate {ADAM}, we have built an end-to-end variant calling
