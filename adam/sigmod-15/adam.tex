...
pipelines, while reducing cost by 50\%. \linebreak From building this system, we were able to distill a set of
...
\hline
\texttt{ADAM} & 32$\star$ & 74m &  &  & 39m23 & 0m43 \\
 & & 17$\times$ & & & 2.1$\times$ & 8.6$\times$ \\
\hline
\texttt{ADAM} & 64$\star$ & 41m52 &  & 24m23 & 18m56 & 0m49 \\
 & & 30$\times$ & & 1.8$\times$ & 4.3$\times$ & 7.5$\times$ \\
\hline
