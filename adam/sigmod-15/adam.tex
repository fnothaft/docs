...
Us & 1 \texttt{hs1.8xlarge} & 12h 58m & \$82.80 \\
...
Us & 1 \texttt{hs1.8xlarge} & 7m 4s & \$1.95 \\
...
The Parquet format is optimized for horizontal scalability as it 

. Specifically, it is 
ADAM demonstrates superior scalability over Hadoop-BAM. This performance is likely because ADAM files can be more evenly distributed across machines.
